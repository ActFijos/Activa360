...
Dadas las restricciones de la UMSS, el despliegue es predominantemente **On-Premise**, pero diseñado con principios Cloud Native (contenedores).

### 8.1 Mapeo de componentes

| Componente | Tecnología de despliegue | Justificación |
| :---- | :---- | :---- |
| API Services | Docker / Kubernetes (institucional) | Escalabilidad y aislamiento |
| Base de datos | PostgreSQL Server | Relacional, robusta, open source |
| Caché | Redis Container | Gestión de colas de sincronización |
...
| :---- | :---- | :---- | :---- |
| 0001 | Adopción de React Native para app móvil | Aceptada | 14/05/2026 |
| 0002 | Uso de NestJS como framework backend | Propuesta | 14/05/2026 |

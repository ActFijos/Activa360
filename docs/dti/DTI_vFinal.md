...
| Enlace al BRD | [BRD vFinal](file:///c:/Users/Administrador/Documents/MaestriaActFijos/Activa360/docs/brd/BRD_vFinal.md) |
| Enlace al MRD | [MRD vFinal](file:///c:/Users/Administrador/Documents/MaestriaActFijos/Activa360/docs/mrd/MRD_vFinal.md) |
| Enlace al PRD | [PRD vFinal](file:///c:/Users/Administrador/Documents/MaestriaActFijos/Activa360/docs/prd/PRD_vFinal.md) |
| Enlace al FSD | [FSD vFinal](file:///c:/Users/Administrador/Documents/MaestriaActFijos/Activa360/docs/fsd/FSD_vFinal.md) |
| Enlace a `AGENTS.md` | [AGENTS.md](file:///c:/Users/Administrador/Documents/MaestriaActFijos/Activa360/AGENTS.md) |
| Enlace a `PROMPT_MAPPING.md` | [PROMPT_MAPPING.md](file:///c:/Users/Administrador/Documents/MaestriaActFijos/Activa360/docs/PROMPT_MAPPING.md) |
...
| **API Gateway / Ruteo** | Nginx Reverse Proxy / Gateway | **Amazon API Gateway** | Punto único de entrada para enrutamiento, validación JWT de Keycloak y limitación de peticiones (rate limiting). |
| **Autenticación (IDP)** | Keycloak (Docker + LDAP UMSS federado) | **Keycloak (AWS ECS/EKS)** | Servidor de identidades centralizado compatible con OIDC/OAuth2 y federación LDAP. |
...
Vive en [PROMPT_MAPPING.md](file:///c:/Users/Administrador/Documents/MaestriaActFijos/Activa360/docs/PROMPT_MAPPING.md). (Refiere a los prompts utilizados durante el desarrollo por los agentes IA en SDLC).
...
- **AuthN / AuthZ**: JWT firmado por Keycloak + Integración OAuth2/OIDC. Control de acceso basado en roles (RBAC) gestionado en Keycloak y validado en la API Gateway/Microservicios.
...
| 0006 | Adopción de Keycloak para Autenticación y React para el Frontend Web | Aceptada | 29/06/2026 |

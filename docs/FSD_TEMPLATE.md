...
| Prompts utilizados | \<IDs de docs/PROMPT\_MAPPING.md, p. ej. PR-FSD-001\> |
...
| :---- | :---- | :---- | :---- |
| **Prompt coverage** | % de casos de uso críticos con prompt‑contrato vivo y testeado | ≥ 80 % | revisión por pares \+ grep en docs/PROMPT\_MAPPING.md |
...
| :---- | :---- | :---- | :---- |
| \<wireframe\_iniciar\_tramite\_v2.png\> | /tramites/nuevo | FSD-UC-001 | ✅ cubierto |
| \<…\> |  |  |  |

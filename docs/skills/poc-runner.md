...
- Ficha de la POC: pocs/POC-NN/POC-NN.md (creada con plantillas/POC\_TEMPLATE.md).  
...
"@poc-runner POC-01. Hipótesis: pgvector resuelve búsqueda semántica con p95 \< 200 ms para 10k embeddings. *Time-box*: 4 horas-persona. Criterio SMART: pytest tests/poc01\_latency.py retorna 0 y reporta p95 \< 200 ms."
